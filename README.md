...
I now had the html and javascript source and the resulting bundle.js in the dist folder.
...
To speedup the process of getting to the world daemon I started fiddling around with the save files.
...
That's it - feel free to use the code and have as much fun with it as I had!

Thanks a lot to the creators of this game!
